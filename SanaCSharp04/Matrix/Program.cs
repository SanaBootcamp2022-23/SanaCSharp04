...
//2
Console.WriteLine($"2 - Максимальне із чисел, що зустрічається в заданій матриці більше одного разу: {MatrixActions.MaxRepeatValue(matrix)}");
//3
...
//5
Console.WriteLine($"5 - Номер рядка, в якому знаходиться найдовша серія однакових елементів: {MatrixActions.RowNumberMaxRepeatElement(matrix)}");
//6
...
//7
Console.WriteLine($"7 - Максимум серед сум елементів діагоналей, паралельних головній діагоналі матриц: {MatrixActions.MaxSumParallelMainDiagonal(matrix)}");
//8
